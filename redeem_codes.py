...
import sys
import base64
# import cv2 (disabled for Termux)
import re
# import numpy as np (disabled for Termux)
from datetime import datetime, timedelta
from glob import glob
# from PIL import (disabled for Termux) Image, ImageEnhance, ImageFilter
...
def parse_args():
    ...
    ocr_choices = []
    available_methods = []
    if False:  # OCR disabled for Termux
        pass
    ...
    if False:  # OCR disabled for Termux
        pass
# OCR requirement disabled for Termux
# sys.exit(1) disabled (OCR not required)

    parser.add_argument('--ocr-method', type=str, default='none', choices=['none'],
